...
export function PackageCard({
  ...
  return (
    <Link href={`/packages/${slug}`} className={cn("block group h-full", className)}>
      <MagicCard
        ...
        <div className="flex flex-col h-full gap-3">
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-red-500 to-orange-500 shadow-lg shadow-red-500/20 shrink-0">
